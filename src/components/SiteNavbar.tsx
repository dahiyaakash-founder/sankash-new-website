              ...
              item.dropdown ? (
                <div key={item.label}>
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-lg px-3 py-3 text-[15px] font-medium text-foreground transition-colors active:bg-accent"
                  >
                    {item.label}
                    ...
                    <div className="space-y-0.5 pb-1 pl-3">
                      {item.dropdown.map((child) => (
                        <Link
                          ...
                          className="block rounded-lg px-3 py-2.5 text-[14px] text-muted-foreground transition-colors active:bg-accent"
                        >
                          {child.label}
                        </Link>
                      ))}
