        ...
        <div className="grid md:grid-cols-3 gap-4">
          {audiences.map((a, i) => (
            ...
            >
              <Link
                to={a.href}
                className="group flex flex-col h-full rounded-2xl border bg-card p-4 sm:p-6 hover:shadow-card-hover hover:border-primary/15 transition-all"
              >
                  <div className={`w-11 h-11 rounded-xl ${a.accent} flex items-center justify-center mb-4`}>
                  <a.icon size={20} />
                </div>
