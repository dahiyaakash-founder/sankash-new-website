-- Add insurance_query to lead_source_type enum
ALTER TYPE public.lead_source_type ADD VALUE IF NOT EXISTS 'insurance_query';

-- Recreate upsert_lead_with_dedup with insurance_query routing
...
BEGIN
  ...
  CASE _lead_source_type::text
    ...
    ELSE
      -- Fallback round-robin for unmapped sources
  ...
  -- Insurance flag override (for contact_form or null source with insurance intent)
